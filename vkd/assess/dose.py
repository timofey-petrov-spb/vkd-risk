...
1. Толщина защиты. Узлы таблиц: 0,01 · 0,1 · 0,3 · 0,5 · 1 · 1,5 · 2 · 3 · 10 г/см².
   ...
   РЕПОЗИТОРИЯ НЕТ, и диапазон 0,5…1,5 г/см² здесь — принятое допущение, а не
   измерение. Косвенно он согласуется с ERI-000501: там глубинная доза в
   скафандрах EMU и «Орлан-М» измерена на глубинах 0,2…1 г/см² (максимумы
   профилей 0,34 г/см² для шлема EMU, 0,46 для образца ткани EMU и 0,65 для
   «Орлан-М»), то есть работа идёт в нижней половине принятого диапазона.
...
RULE_RU = (
    ...
    'по 60 суткам эфемериды МКС; 1 рад(Si) = 10 мГр(Si); формула (13) вкладки «Методика»'
)
...
LIMITS_RU = (
    ...
    # Без внешних скобок вокруг «рад (Si)»: на экране действует запрет вложенных скобок (R5-8),
    # и «(таблицы стандарта подписаны «рад (Si)»)» его нарушало — поймано test_round6_integration.
