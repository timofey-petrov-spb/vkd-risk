...
ограничена двумя уже существующими рубежами: кеш экрана (`app/main.py`, `@st.cache_data(ttl=300)` —
срок задан числом в коде, а не ключом `[sources].cache_ttl_s`; это названо ограничением в README,
раздел 13)
