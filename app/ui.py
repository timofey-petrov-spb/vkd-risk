...
/* ТЁМНАЯ тема. Палитра означает то же, что и прежде, — ПРОИСХОЖДЕНИЕ величины, — но собрана
   ...
   как поломка. */
:root { --ink:#e4e7ea; --muted:#9da1a8; --line:#22262d; --bg:#08090b; --soft:#101217;
...
DARK_PAPER, DARK_PLOT, DARK_GRID = '#08090b', '#101217', '#22262d'
...
REPALETTE = {
    ...
    '#0e1117': '#08090b', '#161b26': '#101217', '#242b38': '#22262d',     # бумага, панель, сетка
