...
CSS = r"""
<style>
/* Public Sans — шрифт государственного стандарта США (USWDS), тот же, которым набран nasa.gov.
   Подключается ОДНОЙ строкой и только тремя начертаниями: 400 — обычный текст, 600 — ярлыки
   капителью, 800 — крупные строки.
